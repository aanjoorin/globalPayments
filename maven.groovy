...
build and push image is a stage in my pipeline and the stage is called in by a function buildImages which is the 
script i posted above, how do i fix this?
