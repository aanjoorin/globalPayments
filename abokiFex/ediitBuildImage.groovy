def call(globalJsonSettings = '{}') {
  defaultJsonSettings = '{"useCache":"false","pushToGCP":"false","reproducibleImage":"false","dockerfileGlob":"**/*Dockerfile","dockerfileExcludes":"**/dev.Dockerfile,**/node_modules/**","imageName":"${IMAGE_NAME}","imageLocation":"${IMAGE_LOCATION}"}'
